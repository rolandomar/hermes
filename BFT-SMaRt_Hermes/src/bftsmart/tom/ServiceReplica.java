...
/**
 * This class implements a TOMReceiver, and also a replica for the server side
 * of the application. It receives requests from the clients, runs a TOM layer,
 * and sends a reply back to the client Applications must create a class that
 * extends this one, and implement the executeOrdered method
 *
 */
